    ...
    return()=>h('div',{class:'gy-config'},[h('style',css),h('div',{class:'gyc-shell'},[
      ...
      h('main',{class:'gyc-body'},[h('div',{class:'gyc-grid'},[
        ...
        h('aside',{class:'gyc-stack'},[
          ...
          h('div',{class:'gyc-card'},[h('h3','上传监控说明'),h('p','开启后在 MoviePilot 系统日志中搜索“【光鸭云盘】【上传】”。'),h('div',{class:'gyc-help'},[h('div',{class:'gyc-tip'},'上传期间每 5% 输出一次进度，并显示已上传大小和平均速度。'),h('div',{class:'gyc-tip'},'上传结束会记录 task_id、fileId、耗时以及最终确认结果。'),h('div',{class:'gyc-tip'},'即使 task 回执缺少 fileId，只要目标目录确认同名同大小文件存在，也会按成功返回给 MoviePilot。'),h('div',{class:'gyc-tip'},'日常使用建议关闭进度监控，减少日志量。')])])
        ])
